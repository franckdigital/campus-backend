...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            email = 'aminata.traore@escam-test.ci'
            parent_email = 'kone.traore@escam-test.ci'
            password = 'campus123'
            ...
            user.last_name = 'Traore'
            user.phone = '+225 01 23 45 67'
            ...
            parent_user.first_name = 'Koné'
            parent_user.last_name = 'Traore'
        ...
        self.stdout.write(
            ...
            "REMINDER_START_DAY) — la date réelle d'aujourd'hui ne suffit donc pas ici.\n"
            'Pour déclencher le rappel tout de suite avec une date simulée après le 25 :\n'
            '  python manage.py test_echeancier_reminders --date 2026-07-25 --email aminata.traore@escam-test.ci'
        )
